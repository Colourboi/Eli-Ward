      ...
      <section className="section section-socials">
        <div className="container">
          <header className="page-header">
            ...
            <p className="section-intro">Find Eli Ward on all platforms.</p>
          </header>
          <div className="socials-list">
            {platforms.map((p) => (
              ...
              >
                <span className="social-row-icon">{p.icon}</span>
                <span className="social-row-info">
                  <span className="social-row-name">{p.name}</span>
                  <span className="social-row-handle">{p.handle}</span>
                </span>
                <svg className="social-row-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
