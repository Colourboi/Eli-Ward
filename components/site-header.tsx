...
const links = [
  ...
  { href: "/socials", label: "Socials", mobileOnly: true },
];
...
export function SiteHeader() {
  ...
  // Lock body scroll when nav is open (prevents horizontal scroll bleed)
  useEffect(() => {
    if (menuOpen) {
  ...
  return (
    <header className={["site-header", scrolled ? "scrolled" : "", isShop ? "shop-header" : ""].filter(Boolean).join(" ")}>
      ...
      <nav className={`nav${menuOpen ? " open" : ""}`} aria-label="Main">
        {links.map((link: NavLink) => (
          <Link
            ...
            href={link.href}
            className={[
              pathname === link.href ? "current" : "",
              link.mobileOnly ? "nav-mobile-only" : "",
